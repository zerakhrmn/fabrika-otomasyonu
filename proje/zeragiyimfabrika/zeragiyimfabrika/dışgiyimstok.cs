...
{
    public partial class dışgiyimstok : Form
    {
        public dışgiyimstok()
        {
            InitializeComponent();
        ...
        private void dışgiyimstok_Load(object sender, EventArgs e)
        {
            ...
            baglan.Open();
            dataAdapter = new SqlDataAdapter("select * from giyim where urunturu= 'dış'", baglan);
